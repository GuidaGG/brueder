...
$(function($){
  ...
  $.fn.okzoom = function(options){
    ...
    return this.each(function(){
      ...
      var parent = $(this).parent().parent().attr('href');
      ...
      base.listener = document.createElement('a');
     if(parent != undefined){
      base.listener.setAttribute('href', parent);
     }
...
$('#isotope, .woocommerce-product-gallery__wrapper, .post').mouseover(function(){
  $('#ok-loupe, #ok-listener').each(function() {
    $(this).css('opacity','0');
});
})
